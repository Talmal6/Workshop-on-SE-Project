...
public class InMemoryProductCatalogTests {
    ...
    void GivenNewProduct_WhenAddCatalogProduct_ThenProductIsAdded() {
        catalog.addCatalogProduct("123", "Laptop", Arrays.asList("Electronics", "Computers"));
    ...
    void GivenValidStoreEntry_WhenaddStoreProductEntry_ThenEntryIsAdded() {
        catalog.addCatalogProduct("123", "Phone", Arrays.asList("Electronics"));
    ...
    void GivenExistingEntry_WhendeleteStoreProductEntry_ThenEntryIsRemoved() {
        catalog.addCatalogProduct("123", "Tablet",  Arrays.asList("Gadgets"));
    ...
    void GivenExistingEntry_WhenupdateStoreProductEntry_ThenEntryIsUpdated() {
        catalog.addCatalogProduct("123", "Camera", Arrays.asList("Photography"));
    ...
    void GivenProducts_WhenGetAllProducts_ThenReturnAllProducts() {
        catalog.addCatalogProduct("1", "Product1",  Collections.singletonList("Category1"));
        catalog.addCatalogProduct("2", "Product2", Collections.singletonList("Category2"));
    ...
    void GivenCategoryWithEntries_WhenGetAllProductsByCategory_ThenReturnEntries() {
        catalog.addCatalogProduct("123", "Headphones",  Arrays.asList("Audio"));
    ...
    void GivenMatchingQuery_WhenSearch_ThenReturnMatchingEntries() {
        catalog.addCatalogProduct("123", "Gaming Mouse",  Arrays.asList("Gaming"));
    ...
    void GivenStoreNameFilter_WhenSearch_ThenReturnMatchingStoreEntries() {
        catalog.addCatalogProduct("123", "Keyboard",  Arrays.asList("Gaming"));
    ...
    void GivenNoMatchingQuery_WhenSearch_ThenReturnEmptyList() {
        catalog.addCatalogProduct("123", "Webcam",  Arrays.asList("Accessories"));
    ...
    void GivenExistingCatalogId_WhenIsProductExist_ThenDoNotThrow() {
        catalog.addCatalogProduct("123", "Speaker" ,Arrays.asList("Audio"));
