...
public class StoreService {
    ...
    @Transactional
    public Result<Void> addLogicalCompositeConditionalDiscountToSpecificProductInStorePercentage(String sessionKey, String storeName, String product_id, int percentage, List<String> products, List<Integer> minAmounts, List<Integer> maxAmounts, int minPrice, String logicType, String coupon) {
        try {
            authenticationService.checkSessionKey(sessionKey);
            String email = authenticationService.getUserBySession(sessionKey);
            userRepository.checkUserSuspension(email);
            storeRepository.addLogicalCompositeConditionalDiscountToSpecificProductInStorePercentage(storeName, email, product_id, percentage, products, minAmounts, maxAmounts, minPrice, coupon, logicType);
            return Result.success(null);
        } catch (Exception e) {
            return Result.failure(e.getMessage());
        }
    ...
    @Transactional
    public Result<Void> addLogicalCompositeConditionalDiscountToEntireStore(String sessionKey, String storeName, int percentage, List<String> products, List<Integer> minAmounts, List<Integer> maxAmounts, int minPrice, String logicType, String coupon) {
        try {
            authenticationService.checkSessionKey(sessionKey);
            String email = authenticationService.getUserBySession(sessionKey);
            userRepository.checkUserSuspension(email);
            storeRepository.addLogicalCompositeConditionalDiscountToEntireStore(storeName, email, percentage, products, minAmounts, maxAmounts, minPrice, coupon, logicType);
            return Result.success(null);
        } catch (Exception e) {
            return Result.failure(e.getMessage());
        }
    ...
    @Transactional
    public Result<Void> addLogicalCompositeConditionalDiscountToEntireCategoryInStore(String sessionKey, String storeName, String category, int percentage, List<String> products, List<Integer> minAmounts, List<Integer> maxAmounts, int minPrice, String logicType, String coupon) {
        try {
            authenticationService.checkSessionKey(sessionKey);
            String email = authenticationService.getUserBySession(sessionKey);
            userRepository.checkUserSuspension(email);
            storeRepository.addLogicalCompositeConditionalDiscountToEntireCategoryInStore(storeName, email, category, percentage, products, minAmounts, maxAmounts, minPrice, coupon, logicType);
            return Result.success(null);
        } catch (Exception e) {
            return Result.failure(e.getMessage());
        }
